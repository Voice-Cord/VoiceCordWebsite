            ...
            <div class="w-100 contain">
                <div class="row block-center">
                    <router-link to="/" class="col-2 me-0 navbar-brand">
                        <img src="@/assets/img/Logo/VoiceCordFull.png" height="70" alt="Logo" title="Logo"
                            style="position:absolute;" />
                    </router-link>

                    <button v-if="false" class="navbar-toggler" type="button" data-toggle="collapse"
                        data-target="#navbarResponsive" @click="toggleNav"
                        ...
                        <i style="
								...
								margin: auto;
							" v-if="isOpen" class="fa-solid fa-xmark"></i>
                    </button>

                    <div class="col-8" style="display: flex; justify-content: center">
                        <div class="nav-items" id="navbarResponsive" :style="
                            useHamburger
                                ? (isOpen
